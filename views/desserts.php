                ...
                <?php foreach ($posts as $post): ?>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        border: 1px solid #4f4f4f; border-radius: 10%; margin: 10px; overflow: hidden;">
                            <img src="<?php echo ROOT . "public/" . $post['dessert_link']; ?>" style="height: 200px" alt="Card image cap">
                            <div class="card-body" style="position: absolute; bottom: 10px;">
                                ...
                                <?php if(isset($_SESSION['user_role']) && $_SESSION['user_role'] != "1"): ?>
                                    <div>
                                        <a href="<?php echo ROOT . "desserts/get/" . $post['DrinkID']?>" class="btn btn-info"><i class="fas fa-info-circle"></i> DETAILS</a>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo ROOT . "desserts/get/" . $post['DrinkID']?>" class="btn btn-info"><i class="fas fa-info-circle" aria-hidden="true"></i> DETAILS</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
