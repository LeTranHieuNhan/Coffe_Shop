        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 pr-5">
                    ...
                    <form action="<?php echo ROOT;?>drinks/edit/<?php echo $post['DrinkID'];?>" method="post" enctype="multipart/form-data">
                    <?php CSRF::createToken();?>    
                        ...
                        <div class="form-group">
                           ...
                           <img src="<?php echo ROOT . "public/" . $post['drinks_img']?>" alt="post_image" class="img-fluid">
                           <input type="file" name="drink-img" class="form-control mt-2">
                        </div>  
                        <input type="hidden" name= "drink-id" value="<?php echo $post['DrinkID'];?>"></input>
                        <?php var_dump($_POST);?>
                        
                        <input type="hidden" name= "drink-img" value="<?php echo $post['drinks_img'];?>"></input>
